...
public class LibretroDroid {
    ...
    public static final int SHADER_CUSTOM = 100;
    ...
    public static native void setNetplayActive(boolean active);
    ...
    public static native void setBackgroundFrameBehind(boolean behind);
